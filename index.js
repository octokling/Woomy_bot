...
function sendModeStageEmbed(message, args, data, mode) {
  ...
  // Créez et configurez les propriétés de stage a embed.
  ...
  message.channel.find("name", 'info-stage').send(stageStyle);

  //Créez et configurez les propriétés de stage b embed.
